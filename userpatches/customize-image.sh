...
$include_board_determiner_directory="/tmp/overlay/boards/$BOARD"
...
function board_determiner() {
	...
	echo -e "Executing Board Determiner!... .. ."
	...
	case $BOARD in
		bananapi)
		    echo "Detected: BananaPi"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapicm4io)
		    echo "Detected: BananaPi CM4IO"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim1plus)
		    echo "Detected: BananaPi M1 Plus"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
        bananapim2)
		    echo "Detected: BananaPi M2"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim2berry)
		    echo "Detected: BananaPi M2 Berry"
			sleep 1
            ...
            ;;
       	bananapim2ultra)
            echo "Detected: BananaPi M2 Ultra"
			sleep 1
			echo "Copying Board Determiner-Files from overlay to /var/lib/bananapi !"
			sleep 1
			cp -r $include_board_determiner_directory $board_determiner_directory
            ...
            ;;
		bananapim2plus)
		    echo "Detected: BananaPi M2 Plus"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim2pro)
		    echo "Detected: BananaPi M2 Pro"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim2s)
		    echo "Detected: BananaPi M2S"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim2zero)
		    echo "Detected: BananaPi M2 Zero"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim3)
		    echo "Detected: BananaPi M3"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim4zero)
		    echo "Detected: BananaPi M4 Zero"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim5)
		    echo "Detected: BananaPi M5"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim7)
		    echo "Detected: BananaPi M7"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapim64)
		    echo "Detected: BananaPi M64"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapipro)
		    echo "Detected: BananaPi Pro"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapir2)
		    echo "Detected: BananaPi R2"
			cp -r $include_board_determiner_directory $board_determiner_directory
            ;;
		bananapir2pro)
		    echo "Detected: BananaPi R2 Pro"
			cp -r $include_board_determiner_directory $board_determiner_directory
	    	;;
	        *)
		    echo "Detected: $BOARD "
